 ...
 * @author Jens Bertram
 */
public final class TermsQueryBuilderTest extends TestCase {
   ...
   */
  @Test
  public void testSetStopWords() throws Exception {
    final Collection<String> newStopWords = IndexTestUtil.getRandomStopWords(
            index);
    ...
    final SimpleTermsQuery stq = instance.buildUsingEnvironment(qb.toString());
  ...
  @Test
  @Ignore
  public void testSetBoolOperator() throws Exception {
    ...
    for (QueryParser.Operator op : QueryParser.Operator.values()) {
      ...
      final String result = instance.setBoolOperator(op).
   ...
   */
  @Test
  public void testBuildFromEnvironment() throws Exception {
    final Collection<String> fields = IndexTestUtil.getRandomFields(index);
   ...
   */
  @Test
  public void testBuildUsingEnvironment() throws Exception {
    TermsQueryBuilder instance;
    final Collection<String> fields = IndexTestUtil.getRandomFields(index);
    final Collection<String> stopwords = IndexTestUtil.getRandomStopWords(
            index);

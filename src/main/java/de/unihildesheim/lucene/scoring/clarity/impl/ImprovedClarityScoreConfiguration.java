...
public final class ImprovedClarityScoreConfiguration extends Configuration {
  ...
  private static enum Keys {
    ...
    fbDocsMax,
    /**
     * Policy to use for simplifying queries. See
     * {@link ImprovedClarityScore.QuerySimplifyPolicy}.
     */
  ...
  /**
   * Get the policy that will be used to simplify a query, if the minimum
  ...
  /**
   * Set the policy that will be used to simplify a query, if the minimum
   * number of feedback documents could not be reached with the original
   * query.
   *
   ...
   * Set the beta parameter value used for document model calculation.
   *
   * @param beta Beta parameter value used for document model calculation.

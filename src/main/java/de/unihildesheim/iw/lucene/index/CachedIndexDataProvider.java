 ...
 * @author Jens Bertram
 */
public final class CachedIndexDataProvider
   ...
   */
  public CachedIndexDataProvider() {
    super(false);
  }
   ...
   * {@link Environment}
   */
  public void cacheBuilder(final String name)
      throws IOException,
             Environment.NoIndexException {
    this.cacheName = name;
...
//    this.dIdp.warmUp();
   ...
   */
  private final class DocTermsMapBuilderTarget
      extends

...
public final class CollectionMetrics {
  ...
  /**
   * Calculate the inverse document frequency (IDF) using a logarithmic base of
   * 10.
   *
  ...
  /**
   * Calculate the Okapi BM25 derivation of the inverse document frequency (IDF)
   * using a logarithmic base value of 10.
   *
   * @param term Term to calculate
  ...
  /**
   * Calculate the Okapi BM25 derivation of the inverse document frequency (IDF)
   * using a custom logarithmic base value.
   *
   * @param term Term to calculate
   * @param logBase Logarithmic base
   * @return Inverse document frequency BM25 (logN)

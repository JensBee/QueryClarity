 ...
 */
public final class FeedbackDocsTable extends AbstractTable {
  /**
   ...
   * Table name.
   */
  public static final String TABLE_NAME = "fb_docs";
  ...
  public static final class Writer
    ...
    public Writer(@NotNull final Connection con)
        throws SQLException {
      super(con, new FeedbackDocsTable());
    }

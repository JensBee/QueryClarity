 ...
 */
public class ICSAnalyzeDB extends AbstractDB {
  /**
   * Database connection.
   */
  ...
  private static final Collection<Class<? extends Table>> ACCEPTED_TABLES =
      Collections.unmodifiableList(Arrays.asList(
          MetaTable.class,
          KeyValueTable.class,
          FeedbackDocsTable.class,
          FeedbackTermsTable.class,
          TermStatsTable.class));
   ...
   */
  public ICSAnalyzeDB(@NotNull final File dbFile)

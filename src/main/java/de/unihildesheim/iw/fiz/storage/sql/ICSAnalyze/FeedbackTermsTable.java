 ...
 */
public final class FeedbackTermsTable extends AbstractTable {
  /**
   ...
   * Table name.
   */
  public static final String TABLE_NAME = "fb_terms";
  ...
  public enum Fields {
    ...
    TERM_REF_FK("foreign key (" + TERM_REF + ") references " +
        TermStatsTable.TABLE_NAME + '(' + TermStatsTable.Fields.ID + ')'),
    /**
     * Scoring result value.
     */
    Q_MODEL("q_model real not null"),
    /**
     * Scoring result value.
     */
    C_MODEL("c_model real not null");
  ...
  public static final class Writer
    ...
    public Writer(@NotNull final Connection con)
        throws SQLException {
      super(con, new FeedbackTermsTable());
    }

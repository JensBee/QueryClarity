 ...
 */
public final class IPCSectionsTable extends AbstractTable {
  /**
   ...
   * Table name.
   */
  public static final String TABLE_NAME = "ipc_sections";
  ...
  public enum Fields {
     ...
     * IPC-Sections count.
     */
    SECTIONS("sections integer not null"),
    /**
     * Counter value.
     */
  ...
  public static final class Writer
    ...
    public Writer(@NotNull final Connection con)
        throws SQLException {
      super(con, new IPCSectionsTable());
    }

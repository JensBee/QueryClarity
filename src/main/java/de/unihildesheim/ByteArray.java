...
/**
 * Wrapper object for byte arrays implementing equals, clone and
 * serialization.
 *
 * @author Jens Bertram
 */
public final class ByteArray
  ...
  /**
   * Create a new {@link ByteArray} from the given bytes taking a local copy
   * of them.
   *
  ...
  /**
   * Create a new {@link ByteArray} from the given bytes taking a local copy
   * of them. Bytes will be copied starting at <tt>offset</tt> (inclusive)
   * using the given <tt>length</tt>.
   *
  ...
  public static final class ByteArraySerializer
    ...
    public ByteArray deserialize(final DataInput in, final int available)
            throws IOException {
      return new ByteArray(Serializer.BYTE_ARRAY.deserialize(in, available));
    }
